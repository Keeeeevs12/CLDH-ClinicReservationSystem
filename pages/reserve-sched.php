<?php
	...
	if (isset($_POST['reserve_sched'])) {
        $sched_id = $_POST['reserve_sched_id'];
		...
		if ($query_reserve = mysqli_query($con, "INSERT INTO appointments (patients_id, sec_id, sched_id, status) VALUES ('$user_id', '$secID', '$sched_id', '0')")) {
            ...
            $query = mysqli_query($con, "INSERT INTO transacs (transac_datetime, transac_mes, transac_user) VALUES (current_timestamp(), '$transac_mes', '$user_name')");
		}
                        ...
                        <table class="table align-items-center table-dark table-flush">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
									<form action="" method="post">
										<input type="hidden" name="reserve_sched_id" value="<?php echo $rows_fetchsched['sched_id']; ?>" />
										<button type="submit" name="reserve_sched" value="<?php echo $rows_fetchsched['sched_id']; ?>" class="btn btn-success btn-sm" <?php if($rows_fetchsched['status']=='1'){echo 'disabled';} ?>>Reserve</button>
									</form>
							  </td>
                            </tr>
								<?php }?>
