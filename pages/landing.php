                ...
                <div class="col-lg-12">
                    <div class="row row-grid justify-content-center" style="padding-top: 30px;">
                        <div class="col-lg-8 text-center">
                          <h2 class="display-3" style="padding-bottom: 30px;"><i class="fa fa-hospital-o" aria-hidden="true"></i> CLINICS</h2>
                          </div>
                    </div>
                </div>
            </div>
                      ...
                      <div class="col-lg-8 text-center">
                        <div class="form-group">
                          <div class="input-group input-group-alternative mb-4">
                            ...
                            <input class="form-control" onkeyup="myFunction()" placeholder="Search for clinics..." id="myFilter" type="text">
                          </div>
                        </div>
                        </div>
                  </div>
